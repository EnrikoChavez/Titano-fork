...
contract LatitudeTesting is ERC20Detailed, Ownable, ReentrancyGuard {
    ...
    uint256 public rewardYield = 39581250000;
    uint256 public rewardYieldDenominator = 10000000000;

    uint256 public rebaseFrequency = 10;
    uint256 public nextRebase = block.timestamp + 5;
    ...
    constructor() ERC20Detailed("LatitudeTesting", "LATIT", uint8(DECIMALS))
    {
